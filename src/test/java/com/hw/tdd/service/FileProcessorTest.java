...
public class FileProcessorTest {
    ...
    void turnUp() {
        ...
        this.fileParser = mock(FileParser.class);
        this.templateParser = mock(TemplateParser.class);
        this.templateValidator = mock(TemplateValidator.class);

        sut = new FileProcessor(scannerHelper, fileParser, templateParser, templateValidator);
    }

    @Test
    void processTemplateFromFile() throws FileException, TemplateFormatException {
        String inputFilename = "inputFilename.txt";
        ...
        when(fileParser.readTemplateFromFile(inputFilename)).thenReturn(template);
        ...
        doNothing().when(fileParser).writeToFile(outputFilename, expectedResult);

        String actualResult = sut.processFile(inputFilename, outputFilename);
